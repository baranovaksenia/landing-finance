// import images
import LogoImg from './public/images/header/logo.png';
...
import { FaFacebookF, FaFax, FaTelegramPlane } from 'react-icons/fa';
...
export const faqData = {
  pretitle: 'FAQ',
  title: 'Need Help? Read Popular Questions',
  ...
  accordions: [
    ...
    {
      question: 'Why Customer Choose Better  Mortgage?',
      answer:
        'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, voluptatum.',
    },
  ],
...
export const footer = {
  ...
  contact: [
    { name: 'Kiriyat Motzkin', icon: <AiFillHome /> },
    { name: 'keterfi@gmail.com', icon: <AiFillEnvironment /> },
    { name: '050 699 27 09', icon: <AiFillPhone /> },
    { name: '050 699 27 09', icon: <FaFax /> },
  ],
  social: [
